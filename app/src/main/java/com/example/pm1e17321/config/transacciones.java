...
public class transacciones {
    ...
    public static final String d = "d"; // foto
    ...
    public static final String CreateTablePesonas = "Create Table contactos (id INTEGER PRIMARY KEY AUTOINCREMENT,pais TEXT, nombres TEXT ,telefono INTEGER, nota TEXT)";
